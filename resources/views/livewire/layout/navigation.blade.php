    ...
    <div class="fixed top-0 z-30 flex w-full items-center justify-between bg-white px-4 py-3 shadow-sm md:hidden">
        ...
        <span class="text-xl font-medium">
            ...
            @elseif(request()->routeIs(['teacher.live-classes']))
                {{ 'Kelas Berlangsung' }}
            @elseif(request()->routeIs(['admin.teachers']))
                {{ 'Guru Pengajar' }}
            @elseif(request()->routeIs(['admin.teacher.subjects']))
                {{ 'Daftar Mapel' }}
            @elseif(request()->routeIs(['admin.subject.sessions']))
                {{ 'Daftar Pertemuan' }}
    ...
    <div x-show="open" x-cloak x-transition:enter="transition ease-out duration-300"
        ...
        <nav class="mt-4 px-4">
            ...
            @role('admin')
                ...
                <x-sidebar-link :href="route('admin.teachers')" :active="request()->routeIs([
                    'admin.teachers',
                    'admin.teacher.subjects',
                    'admin.subject.sessions',
